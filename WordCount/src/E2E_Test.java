...
public class E2E_Test {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        PrintStream ps = new PrintStream("//Users//rsalecha//Downloads//jate_test//JalPaanZomato_All_Reviews.txt");
        ...
        //hotel_list.add("https://www.zomato.com/bangalore/jalpaan-eat-street-jayanagar");
		...
		if(driver.findElement(By.xpath("//a[contains(@class,'default-section-title everyone empty')]")).isEnabled()){
        ...
        PrintStream final_results = new PrintStream("//Users//rsalecha//Downloads//jate_test//JalPaanZomato_Final_Results.txt");
		...
		while (MenuListIterator.hasNext()) {
			int count = countWord(MenuListIterator.next(),"//Users//rsalecha//Downloads//jate_test//JalPaanZomato_All_Reviews.txt");
		}
